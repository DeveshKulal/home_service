import 'package:service/animation/FadeAnimation.dart';
import 'package:service/models/service.dart';
import 'package:flutter/material.dart';
import 'package:service/pages/profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> workers = [
    ...
    [
      'Brenon Kalu',
      'Driver',
      'https://mighty.tools/mockmind-api/content/human/23.jpg',
      4.4
    ]
  ];
    ...
    return GestureDetector(
      child: Container(
        ...
        child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Flexible(child: Image.network(image, height: 45)),
              SizedBox(
                height: 20,
              ),
              Flexible(
